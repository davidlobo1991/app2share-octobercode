<?php namespace App2share\App\SocialLoginProviders;

use Backend\Widgets\Form;
use Flynsarmy\SocialLogin\SocialLoginProviders\SocialLoginProviderBase;
use URL;

class Instagram extends SocialLoginProviderBase
{
    use \October\Rain\Support\Traits\Singleton;

    protected $driver = 'instagram';
    ...
    protected function init()
    {
        ...
        $this->callback = URL::route('flynsarmy_sociallogin_provider_callback', ['Instagram'], true);
    }
    ...
    public function getAdapter()
    {
        if (!$this->adapter) {
            ...
            $this->adapter = new \Hybridauth\Provider\Instagram([
                'callback' => $this->callback,

                'keys' => [
                    'id' => @$providers['Instagram']['client_id'],
                    'secret' => @$providers['Instagram']['client_secret'],
                ],
    ...
    public function isEnabled()
    {
        ...
        return !empty($providers['Instagram']['enabled']);
    }
    ...
    public function isEnabledForBackend()
    {
        ...
        return !empty($providers['Instagram']['enabledForBackend']);
    }
    ...
    public function extendSettingsForm(Form $form)
    {
        $form->addFields([
            'providers[Instagram][enabled]' => [
                ...
                'type' => 'checkbox',
                'comment' => 'Can frontend users log in with Instagram?',
                'default' => 'true',
                'span' => 'left',
                'tab' => 'Instagram',
            ],

            'providers[Instagram][enabledForBackend]' => [
                'label' => 'Enabled on backend?',
                'type' => 'checkbox',
                'comment' => 'Can administrators log into the backend with Instagram?',
                'default' => 'false',
                'span' => 'right',
                'tab' => 'Instagram',
            ],
